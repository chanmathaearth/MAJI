...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 08, 2024 at 08:32 AM
...
CREATE TABLE `delivery` (
  ...
  `deliveryStatus` enum('กำลังจัดการออเดอร์','กำลังจัดส่ง','จัดส่งเสร็จสิ้น','ยกเลิกออเดอร์') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'พีม', '0967546354', '24 ซ.พิบูลสงคราม 22 แยก 22 ต.บางเขน อ.เมือง จ.นนทบุรี', 'จัดส่งเสร็จสิ้น'),
...
INSERT INTO `orderdetail` (`orderId`, `menuId`, `menuQuantity`, `menuStatus`) VALUES
(1, 1, 1, 'ได้รับเมนู'),
(1, 3, 1, 'ได้รับเมนู'),
(1, 6, 1, 'ได้รับเมนู'),
(1, 2, 1, 'ได้รับเมนู'),
...
(2, NULL, NULL, 1, '', 560, '2024-03-08 14:25:13', 'เสร็จสิ้นออเดอร์', 2),
(3, NULL, 1, NULL, 'ไม่เอาผัก', 450, '2024-03-01 10:14:40', 'ได้รับออเดอร์', 2);
...
CREATE TABLE `payment` (
  ...
  `paymentMethod` enum('เงินสด','โอนชำระ') NOT NULL,
  `paymentDateTime` datetime NOT NULL DEFAULT current_timestamp(),
  `paymentStatus` enum('กำลังชำระเงิน','ชำระเงินเสร็จสิ้น','ยกเลิก') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(3, 2, NULL, 450, 'เงินสด', '2024-03-01 16:19:50', 'ชำระเงินเสร็จสิ้น'),
(4, 3, NULL, 560, '', '2024-03-01 16:20:14', 'กำลังชำระเงิน');
