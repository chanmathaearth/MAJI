      ...
      <tbody>
        ...
        foreach ($data as $value) {
          ...
          echo "<td class='text-center' style='width: 150px'>
                  <button data-modal-target='default-modal' data-modal-toggle='default-modal' class='block text-white bg-[#ef4444] hover:bg-[#dc2626] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center' type='button'
          ...
          echo "<div id='modal{$i}' class='modal'>
              <div class='modal-content'>
               ...
               <div class='modal-footer'>
                  <a href='detail_delivery.php' id='delivery' class='text-center w-full bg-red-500 hover:bg-red-600 active:bg-red-700 focus:outline-none focus:ring focus:ring-red-300 text-white font-bold rounded py-2 text-sm transition duration-300 ease-in-out' 
                  onclick='document.getElementById(\"modal{$i}\").style.display = \"none\"'>จัดส่งอาหาร</a>
               </div>
               </div>
         </div>";
          $i++;
