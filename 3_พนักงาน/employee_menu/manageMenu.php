...
<body>
    ...
    <form method="GET" class="max-w-md mx-auto">
        <div class="relative">
            ...
            <input type="search" name="menuName" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 " placeholder="ชื่อเมนู" required />
    ...
    if (isset($_GET['menuName'])) {
        $show = $_GET['menuName'];
        $sql = "SELECT * FROM menu WHERE menuName= '$show'";
        $result = mysqli_query($conn, $sql);
        if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo   '<div id="menuTable" class="bg-white pr-8 pl-8 pb-8">';
                echo '<div class="flex justify-center">';
                echo     '<table class="mt-10 w-1/2 border border-collapse ">';
                echo        '<thead>';
                echo            '<tr class="bg-slate-200 w-full">';
                echo                '<th class="py-2 px-4 border"> ชื่อเมนู </th>';
                echo                '<th class="py-2 px-4 border"> ราคา </th>';
                echo                '<th class="py-2 px-4 border"> รายละเอียดเมนู </th>';
                echo            "</tr>";
                echo        "</thead>";
                echo        "<tbody>";
