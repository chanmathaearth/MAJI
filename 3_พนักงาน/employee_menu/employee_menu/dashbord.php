...
<body class="bg-white" style="
	...
	<div class="px-4 pt-6">
		<div class="grid gap-4 xl:grid-cols-4 p-10">
			<div class="bg-white p-4 shadow-md rounded-md p-4 2xl:col-span-2 sm:p-6">
				<div class="flex items-center justify-between mb-4">
					<div class="flex-shrink-0">
						<span class="text-xl font-bold leading-none text-green-600 sm:text-2xl">500$</span>
				...
				<div class="flex items-center justify-between pt-3 mt-4 border-t border-gray-200 sm:pt-6">
					<div>
						<button class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-900" type="button" data-dropdown-toggle="weekly-sales-dropdown">
							7 วันที่ผ่านมา
						...
						<div class="z-50 hidden my-4 text-base list-none bg-gray-50 divide-y divide-gray-100 rounded shadow" id="weekly-sales-dropdown">
							<ul class="py-1" role="none">
								<li>
									<a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">เมื่อวาน</a>
								</li>
								<li>
									<a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">วันนี้
									</a>
								</li>
								<li>
									<a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">7
										วันที่ผ่านมา
									</a>
								</li>
								<li>
									<a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">30
										วันที่ผ่านมา
									</a>
								</li>
								<li>
									<a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">90
										วันที่ผ่านมา
									</a>
								</li>
							</ul>
			...
			<div class="bg-white p-4 shadow-md rounded-md p-4 2xl:col-span-2 sm:p-6 2xl:col-span-2 sm:p-6">
				<div class="flex items-center justify-between mb-4">
					<div class="grid place-content-center flex-shrink-0">
						<h3 class="text-base font-light text-gray-500 ">
							เมนูยอดนิยม
						</h3>
						<span class="text-xl font-bold leading-none text-green-600 sm:text-2xl">
							<img src="1.png" class="w-36" alt="">
							<div class="flex items-center text-sm text-yellow-900 "> เซตปลาแซลมอนย่างเกลือกระทะร้อน </div>
							<div class=" text-sm text-yellow-900"> 315.- </div>
						</span>
			...
			<div class="bg-white p-4 shadow-md rounded-md p-4 2xl:col-span-2 sm:p-6 2xl:col-span-2 sm:p-6">
				<div class="flex items-center justify-between mb-4">
					<div class="flex-shrink-0">
						<span class="text-xl font-bold leading-none text-amber-800 sm:text-2xl"> 200 คน</span>
						<h3 class="text-base font-light text-gray-500">
							จำนวนลูกค้าที่เข้าใช้บริการที่ร้าน
						</h3>
					</div>
				</div>
			</div>
			<div class="bg-white p-4 shadow-md rounded-md p-4 2xl:col-span-2 sm:p-6 2xl:col-span-2 sm:p-6">
				<div class="flex items-center justify-between mb-4">
					<div class="flex-shrink-0">
						<span class="text-xl font-bold leading-none text-amber-800 sm:text-2xl"> 150 คน</span>
						<h3 class="text-base font-light text-gray-500 ">
							จำนวนลูกค้าที่ใช้บริการจัดส่ง
						</h3>
					</div>
				</div>
			</div>
				...
				<div class="overflow-hidden shadow sm:rounded-lg">
					<table class="min-w-full divide-y divide-gray-200">
						<thead class="bg-red-800 text-white">
							<tr>
								<th scope="col" class="p-4 text-xs font-medium tracking-wider text-left uppercase">
									ธุรกรรม
								</th>
								<th scope="col" class="p-4 text-xs font-medium tracking-wider text-left uppercase">
									วัน และ เวลา
						...
						<tbody class="bg-gray-50">
							<tr>
								<td class="p-4 text-sm font-normal text-gray-900 whitespace-nowrap">
									ชำระเงินจาก
									<span class="font-bold text-green-400">จีนะ เกิดแก้ว</span>
								</td>
								...
								<td class="p-4 whitespace-nowrap">
									<span class="bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md">Completed</span>
								</td>
							</tr>
						</tbody>
					</table>
