    ...
    <div>
        ...
        <div id="dropdownmenu"
            ...
            <script>
                ...
                <li class="">
                    <button onclick="getLocation()" class="flex items-center px-4 py-2 text-black rounded-3xl text-red-600 font-bold hover:bg-gray-100 w-44 " style="font-size: 14px;">
